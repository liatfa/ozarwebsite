...
const Intro = () => {
  ...
  return (
    <div className='intro'>
      ...
      <h2>...אודותי</h2>
        ,נעים מאוד <br />
אני אוצר מלי שמעון, פסיכותרפיסטית מורשת ומטפלת קוגנטיבית התנהגותית בשיטת
הנני בוגרת תואר ראשון בפסיכולוגיה ובעלת תואר שני
בעלת הכשרות בפסיכותרפיה,גישור והדרכת הורים
<br />
<br />
